...
QT_MOC_LITERAL(1, 10, 15), // "SetHomeLocation"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 14), // "QGeoCoordinate"
QT_MOC_LITERAL(4, 42, 11), // "_coordinate"
QT_MOC_LITERAL(5, 54, 18) // "SetPositionPressed"

    },
    "CSettings\0SetHomeLocation\0\0QGeoCoordinate\0"
    "_coordinate\0SetPositionPressed"
};
...
void CSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SetHomeLocation((*reinterpret_cast< QGeoCoordinate(*)>(_a[1]))); break;
        case 1: _t->SetPositionPressed(); break;
        default: ;
        }
        ...
        {
            using _t = void (CSettings::*)(QGeoCoordinate );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CSettings::SetHomeLocation)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CSettings::staticMetaObject = {
...
// SIGNAL 0
void CSettings::SetHomeLocation(QGeoCoordinate _t1)
{
